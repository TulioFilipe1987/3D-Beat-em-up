...
public class AnimationTags{// As tegs que contem os parametros 
   ...
   // TAGS OF ---"ENEMY" --BELOW
    ...
    public const string DEATH_TRIGER = "Death";


}

public class Axis// para pegar os movimentos 
{
...
public class Tags//  para pegar as tags
{
    ...
    public const string LEFT_ARM_TAG = "Horizontal";
